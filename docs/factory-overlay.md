# Factory overlay (corporate / site contract)

This file is the SafetyMP corporate/site overlay previously at the root of
`AGENTS.md`. Public contributors and coding agents should start at
[AGENTS.md](../AGENTS.md). Do not treat this overlay as the community contract.
...
and [ADR 0007](adr/0007-opal-policy-mirror.md).
