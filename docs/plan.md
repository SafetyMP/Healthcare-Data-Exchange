...
**`demo.sh`:** intra-EU + US TEFCA secondary, cross-bloc deny/derivative exception, consent denial, **live consent revoke/grant via OPAL (ADR 0008)**, region-level erasure, AI human-oversight gate — against docker-compose.
